...
class FactRepository(FactRepositoryInterface):
    ...
    async def create(self, entity: BaseModel) -> str:
        ...
        return await self.create_fact(fact_data, fact_data.get("entity_id"))
    
    async def update(self, fact_id: str, data: Dict[str, Any]) -> bool:
    ...
    async def delete(self, fact_id: str) -> bool:
        ...
        try:
            ...
            """
            result = await self.neo4j_repo.execute_query(query, {"fact_id": fact_id})
