...
from core.interfaces.persistence import SystemRepositoryInterface, QueryInterface


class SystemService:
    """Domain service for system business logic."""
    
    def __init__(self, system_repository: SystemRepositoryInterface, query_interface: QueryInterface):
    ...
    async def apply_system_to_story_with_validation(self, system_id: str, story_id: str) -> Dict[str, Any]:
        ...
        if conflicts:
            return {"success": False, "errors": ["System conflicts detected"], "conflicts": conflicts}
    ...
    async def resolve_system_rules(self, story_id: str, scene_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def validate_action_against_rules(self, action: Dict[str, Any], story_id: str, scene_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def update_system_rules_with_validation(self, system_id: str, rule_updates: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _get_system_details(self, system_id: str) -> Optional[Dict[str, Any]]:
        """Get system details."""
    ...
    async def _detect_system_conflicts(self, new_system: Dict[str, Any], existing_systems: List[Dict[str, Any]]) -> List[str]:
    ...
    async def _resolve_rules_hierarchy(self, systems: List[Dict[str, Any]], scene_context: Dict[str, Any]) -> Dict[str, Any]:
        """Resolve rules in priority order."""
        resolved = {}
    ...
    async def _check_rule_violations(self, action: Dict[str, Any], rules: Dict[str, Any]) -> List[str]:
    ...
    async def _generate_rule_suggestions(self, violations: List[str], rules: Dict[str, Any]) -> List[str]:
        """Generate suggestions to fix rule violations."""
        return [f"To fix '{violation}', consider..." for violation in violations]
    
    async def _analyze_rule_change_impact(self, system_id: str, rule_updates: Dict[str, Any]) -> Dict[str, Any]:
