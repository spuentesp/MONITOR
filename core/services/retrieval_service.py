...
class RetrievalService:
    ...
    def search(
        ...
        *,
        ...
        v_res = self.qdrant.search(
            vector=v, limit=k, collection=vector_collection, query_filter=filter_terms
        )
        t_res = self.opensearch.search(
            index=text_index, query=query, size=k, filter_terms=filter_terms
        )
